...
//        top.isActive = true // isActive = true: 레이아웃 활성화
//
...
//        NSLayoutConstraint(item: passwordTextField, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .height, multiplier: 1, constant: 60).isActive = true
        ...
        NSLayoutConstraint.activate([
            signButton.centerXAnchor.constraint(equalTo: view.centerXAnchor), // 상대적인 차이
            signButton.widthAnchor.constraint(equalToConstant: 300), // 절대 값
